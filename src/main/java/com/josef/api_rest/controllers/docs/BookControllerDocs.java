...
public interface BookControllerDocs {
    ...
    @Operation(summary = "Finds a book",
            description = "Find a specif book by his Id",
            tags = {"Book"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "Create a book",
            description = "create a book based on the JSON sent",
            tags = {"Book"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "Update a book",
            description = "Update a book based on JSON sent",
            tags = {"Book"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "delete a book",
            description = "delete a book based on Id informed",
            tags = {"Book"},
            responses = {
                    @ApiResponse(
                            description = "Success",
