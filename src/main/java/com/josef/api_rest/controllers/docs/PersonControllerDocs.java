...
public interface PersonControllerDocs {
    ...
    @Operation(summary = "Export people",
            description = "Export people in a file like xlsx or csv depending on header",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    @Operation(summary = "Insert people through data file",
            description = "Insert many people as need through a file as .csv ou .xlsx",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
    ...
    List<PersonDTO> dataCreation(MultipartFile file);
